...
-- Dump start time: Thu Apr 23 19:02:03 2020
...
SET NAMES utf8mb4;
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ijdb_sample` /*!40100 DEFAULT CHARACTER SET latin1 */;
CREATE TABLE `ijdb_sample`.`author` (
...
;
INSERT INTO `ijdb_sample`.`joke` VALUES (34,"login2",8,"2020-04-04",16),(35,"andrei_password_joke333",7,"2020-04-17",15),(36,"ready",9,"2020-04-09",16),(37,"comae",4,"2020-04-23",15);
...
-- Dump end time: Thu Apr 23 19:02:04 2020
